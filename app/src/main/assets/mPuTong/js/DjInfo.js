angular.module('mDjInfo', ['starter', 'ui.router', 'jwMobile.serivces', 'jwMobile.directives', 'jwMobile.controllers', 'tabSlideBox'])
    ...
    .controller('DJKJInfoCtrl', function ($scope, $stateParams, $state, $ionicPopover, $ionicSlideBoxDelegate, PopupF, PublicInfoP, PublicFnF) {
